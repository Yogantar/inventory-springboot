...
public interface UserRepository extends CrudRepository<Dealer, Long>{  // long is type of primary key

	/*JPA finder methods are the most powerful methods, we can create finder 
	 * methods to select the records from the database without writing SQL queries.
