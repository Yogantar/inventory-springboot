...
//	=====================================================================================================
	...
	public String saveDealer(HttpServletRequest req,@ModelAttribute("dealer") Dealer dealer)
	{
		...
		lService.saveDealer(dealer); // interacts/invokes service layer method for database logic implementation
...
//	==========================================================================================================================================
	...
	public ModelAndView loginDealer(HttpServletRequest req,@ModelAttribute("dealer") Dealer dealer)
	{
		...
		Dealer d=lService.findByEmail(email); // fetch record/object from table matching the email id
...
//			Display the list of products after successful login
			List<Product> listProducts = pService.listAll(); // fetches all records from product table(mapped with Product class) through ProductService class
